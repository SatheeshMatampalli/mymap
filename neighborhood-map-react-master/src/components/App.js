...
class App extends Component {
  ...
  componentDidMount() {
    ...
    loadMapJS(
      "https://maps.googleapis.com/maps/api/js?key=AIzaSyBfGqoqxxliQhePx9PglQDY5LYie5CXHQg&callback=initMap"
    );
  }
  ...
  initMap() {
    ...
    var map = new window.google.maps.Map(mapview, {
      center: { lat: 18.209464, lng: 81.697191 },
      zoom: 5,
      styles:styles,
      mapTypeContron:false
  ...
  getMarkerInfo(marker) {
    ...
    var clientId = "ZA54BUI3OISLHK02UIQBZJYGTE21GOXAGD0GRB3E02OQ0PHA";
    var clientSecret = "Z5ZZWNR0U04PC3M552DLJ2CYCRYUHLK31IIR2KKJWE3AOQ03";
